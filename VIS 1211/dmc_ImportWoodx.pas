...
type
  ...
  private
    ...
    procedure ExportDeliveryMessageReference(const InternalInvoiceNo,
      ShippingPlanNo: Integer);
    procedure ExportPartyID(const InternalInvoiceNo, ShippingPlanNo: Integer);
    procedure ExportNameAddress(const InternalInvoiceNo, ShippingPlanNo
      : Integer);
    procedure ExportDMS(const InternalInvoiceNo, ShippingPlanNo: Integer);
    procedure ExportDSDMR(const ShippingPlanNo, InternalInvoiceNo,
      DeliveryShipmentLineItemNumber: Integer);
    procedure ExportProductID(const ShippingPlanNo, InternalInvoiceNo: Integer;
      const ProductIdentifier: String;
      const DeliveryShipmentLineItemNumber: Integer);
    procedure ExportTrpPkgInfo(const ShippingPlanNo, InternalInvoiceNo,
      DeliveryShipmentLineItemNumber, ProductNo: Integer);
    procedure ExportLengthSpec(const ShippingPlanNo, InternalInvoiceNo,
      DeliveryShipmentLineItemNumber: Integer; const Identifier: String);
    procedure ExportInformationalQuantity(const ShippingPlanNo,
