...
type
  ...
  public
    { Public declarations }
    report_Name, report_Option, rpt_FilePath, store_Path, pdf_Name, print_Type, paramText : String;
...
begin
      ...
      print_Type := IntToStr(rg_PrintSetUp.ItemIndex);
       ...
       else if (rg_ReportOptions.ItemIndex = 1) And (rg_PrintSetUp.ItemIndex = -1) then
       ...
       else if (server_Name = '') And (database_Name = '') And (userID = '') And (password = '') then
        ...
        //     VarArray[0]:= param;
             ...
             if rg_ReportOptions.ItemIndex = 0 then
              Begin
                ...
                PreviewForm.Show;
                PreviewForm.set_Print(report_Name, rpt_FilePath, report_Option, print_Type, store_Path, pdf_Name, safeArray, server_Name, database_Name, userID, password, iSecurity);
              End
             else
              PrintUnit.set_Print(report_Name, rpt_FilePath, report_Option, print_Type, store_Path, pdf_Name, safeArray, server_Name, database_Name, userID, password, iSecurity);
