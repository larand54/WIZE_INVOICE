...
uses
  ...
  cxGridCustomPopupMenu, cxGridPopupMenu, FireDAC.Stan.Intf,
  FireDAC.Stan.Option,
...
begin
  ...
  Begin
    ...
    sp_Vis_Intra_Stat_Exp.ParamByName('@FromDate').AsSQLTimeStamp :=
      DateTimeToSQLTimeStamp(cds_PropsStartPeriod.AsDateTime);
    sp_Vis_Intra_Stat_Exp.ParamByName('@ToDate').AsSQLTimeStamp :=
