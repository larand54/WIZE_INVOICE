...
type
  ...
  private
    ...
    CurRow : Integer ;
    FirstSumRow : Integer ;
    procedure SetCellTextNormalFont2(ACol, ARow : Integer; AText : String;const AA : variant);
...
procedure TfAccInv.SetCellTextNormalFont2(ACol, ARow : Integer; AText : String;const AA : Variant);
begin
  // get a cell object for the request col and row
  with ssAccLager.ActiveSheet.GetCellObject(ACol,ARow) do
  begin
...
Begin
 ...
 Begin
  SetCellTextBold(x,CurRow, sp_ExportInvoiceData.Fields.Fields[x].DisplayLabel);
 End;
...
Begin
 for x := 0 to sp_ExportInvoiceData.Fields.Count - 1 do
 Begin
  SetCellTextNormalFont2(x,CurRow, sp_ExportInvoiceData.Fields.Fields[x].AsString, $00);
 End;
{
 SetCellTextNormalFont2(0,CurRow, cds_ExportTyp1PackageNo.AsString, $01);
 SetCellTextNormalFont2(1,CurRow, cds_ExportTyp1NomThick.AsString, $00);
...
//  ShowMessage('Emailadress saknas för klienten, ange adressen i mailet(outlook)') ;
 ...
 Try
  dm_SendMapiMail.SendMail('Faktura/specifikation. Fakturanr: ' + teInvoiceNo.Text
  + ' - Invoice/package specification. InvoiceNo: ' + teInvoiceNo.Text,
