...
uses
  ...
  cxGrid, ActnList, Menus, cxLookAndFeels, cxLookAndFeelPainters ;
...
begin
 With dmModule1 do
 Begin
  cds_CreGrpCli.ParamByName('grpNo').AsInteger  := dmModule1.cds_CreLimgrpno.AsInteger ;
...
begin
 With dmModule1 do
 Begin
  acRemoveKund.Enabled:= (cds_CreGrpCli.Active) and (cds_CreGrpCli.RecordCount > 0) ;
 End ;
end;
