object dm_ReGenPkg: Tdm_ReGenPkg
  ...
  object mtPackages: TkbmMemTable
    ...
    Left = 496
    Top = 224
    object mtPackagesProductGroupNo: TIntegerField
      FieldName = 'ProductGroupNo'
    end
    object mtPackagesProductNo: TIntegerField
      FieldName = 'ProductNo'
    end
    ...
    object mtPackagesGradeStampNo: TIntegerField
      FieldName = 'GradeStampNo'
    end
    object mtPackagesBarCodeID: TIntegerField
      FieldName = 'BarCodeID'
    end
    object mtPackagesSurfacingNo: TIntegerField
      FieldName = 'SurfacingNo'
    end
    object mtPackagesACT_THICK: TFloatField
      FieldName = 'ACT_THICK'
    end
    object mtPackagesACT_WIDTH: TFloatField
      FieldName = 'ACT_WIDTH'
    end
    object mtPackagesNOM_THICK: TFloatField
      FieldName = 'NOM_THICK'
    end
    object mtPackagesNOM_WIDTH: TFloatField
      FieldName = 'NOM_WIDTH'
    end
    object mtPackagesTOTALPCS: TIntegerField
      FieldName = 'TOTALPCS'
    end
    object mtPackagesLIPNo: TIntegerField
      FieldName = 'LIPNo'
    end
    object mtPackagesPACKAGENO: TIntegerField
      FieldName = 'PACKAGENO'
    end
    object mtPackagesSupplierNo: TIntegerField
  ...
  object sq_PkgToCheck: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'Select distinct'
      ...
      #9#9#9#9'AND pn.SupplierCode = pp.SupplierCode'
      ...
      'Inner Join dbo.Product pd ON pd.ProductNo = pt.ProductNo'
        ...
        'GroupNo'
      ''
      'WHERE pp.SupplierCode = '#39'vt'#39
      'AND pp.ProductionDate > '#39'2007-01-01'#39
      ''
      '')
    SQLConnection = dmsConnector.SQLConnection
    Left = 720
    Top = 32
    object sq_PkgToCheckPackageTypeNo: TIntegerField
      FieldName = 'PackageTypeNo'
    end
    object sq_PkgToCheckNT: TFloatField
      FieldName = 'NT'
    end
    object sq_PkgToCheckSurfacingNo: TIntegerField
      FieldName = 'SurfacingNo'
    end
    object sq_PkgToCheckProductNo: TIntegerField
      FieldName = 'ProductNo'
    end
    object sq_PkgToCheckPRODUKT: TStringField
      FieldName = 'PRODUKT'
      Size = 100
    end
    object sq_PkgToCheckPKTNR: TIntegerField
      FieldName = 'PKTNR'
    end
    object sq_PkgToCheckLEVKOD: TStringField
      FieldName = 'LEVKOD'
      FixedChar = True
      Size = 3
    end
    object sq_PkgToCheckAT: TFloatField
      FieldName = 'AT'
    end
    object sq_PkgToCheckAB: TFloatField
      FieldName = 'AB'
    end
    object sq_PkgToCheckProductGroupNo: TIntegerField
      FieldName = 'ProductGroupNo'
    end
    object sq_PkgToCheckNB: TFloatField
      FieldName = 'NB'
    end
    object sq_PkgToCheckGradeStamp: TIntegerField
      FieldName = 'GradeStamp'
    end
    object sq_PkgToCheckBarcodeid: TIntegerField
      FieldName = 'Barcodeid'
    end
    object sq_PkgToCheckSupplierNo: TIntegerField
      FieldName = 'SupplierNo'
    end
  end
  object sq_PkgTypeLengths: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    SQL.Strings = (
        ...
        'Select distinct pl.ActualLengthMM, pl.ProductLengthNo, ptd.NoOfP' +
        'ieces'
      ''
      'FROM  dbo.PackageTypeDetail ptd '#9
    ...
    Left = 616
    Top = 96
    object sq_PkgTypeLengthsActualLengthMM: TFloatField
      FieldName = 'ActualLengthMM'
    end
    object sq_PkgTypeLengthsProductLengthNo: TIntegerField
      FieldName = 'ProductLengthNo'
    end
    object sq_PkgTypeLengthsNoOfPieces: TIntegerField
      FieldName = 'NoOfPieces'
    end
  end
  object sp_UpdatePackageNo: TSQLStoredProc
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
