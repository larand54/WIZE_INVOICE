...
type
  TImportExportFunctionGetDeliveryMessageNumber = function : Integer ;
...
uses
  DeliveryMessageWoodV2R31, Dialogs, ADODB, Classes;
...
begin
  ...
  begin
    try
      if FileExists(GetOutPutPackageFileName) then
...
//Lars
  ...
  DoImportExport('select * from DeliveryMessageReference', ExportDeliveryMessageReference, dsInfo);
  ...
  DoImportExport('select * from DeliveryMessageShipment', ExportDeliveryMessageShipment, dsInfo);
  ...
  sTotalQuantityValue        := dsInfo.FieldByName('TotalQuantityValue').AsString       ;
...
//      dsInfo.FieldByName('DeliveryMessageNumber').AsString := DeliveryMessageNumber;
    ...
    begin
      ...
      DoImportExport('select * from DeliveryShipmentDeliveryMessageReference', ExportDeliveryShipmentDeliveryMessageReference, dsInfo, DSLI);  //

      DoImportExport('select * from ProductIdentifier', ExportProductIdentifier, dsInfo, DSLI);  //

      ////2013.03.02 Add by Jonny Zheng (Gear1023@163.com) <<<////
      DSLI.PurchaseOrderInformation.PurchaseOrderNumber := 'POPOPO';
      DSLI.PurchaseOrderInformation.PurchaseOrderIssuedDate.Date.Year := '2013' ;
      DSLI.PurchaseOrderInformation.PurchaseOrderIssuedDate.Date.Month := 03 ;
      DSLI.PurchaseOrderInformation.PurchaseOrderIssuedDate.Date.Day := 02 ;
      ////2013.03.02 Add by Jonny Zheng (Gear1023@163.com) >>>////
    ...
    begin
      ...
      begin
        ...
        begin
            ...
            sQuantityValue     := dsInfo.FieldByName('QuantityValue').AsString;
            sQuantityUOM       := dsInfo.FieldByName('QuantityUOM').AsString;
             ...
             begin
               ...
               TPI.PackageType := sPackageType;
                ...
                DoImportExport('select * from InformationalQuantity', ExportInformationalQuantity, dsInfo, TPI);

                DoImportExport('select * from LengthSpecification', ExportLengthSpecification, dsInfo, TPI);
