...
type
  TdmsContact = class(TDataModule)
    ...
    sq_GetEmailAdr_Utlastad: TADQuery;
    sq_GetEmailAdr_UtlastadEmailAddress: TStringField;
    sp_GetLegoOfLL: TADStoredProc;
...
function  TdmsContact.GetLocalSupplierNo(const LoadingLocationNo  : Integer) : Integer ;
Begin
