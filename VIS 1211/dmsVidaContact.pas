...
type
  TdmsContact = class(TDataModule)
    ...
    cds_ReportStaticsIIBankGiro: TStringField;
    ds_ReportStatics: TDataSource;
    cds_ReportStatics: TFDQuery;
    cds_ReportStaticsSalesRegionNo: TIntegerField;
    cds_ReportStaticsDocType: TIntegerField;
    cds_ReportStaticsAdress: TStringField;
    cds_ReportStaticsTelefon: TStringField;
    cds_ReportStaticsInternet: TStringField;
    cds_ReportStaticsOrgNo: TStringField;
    cds_ReportStaticsFax: TStringField;
