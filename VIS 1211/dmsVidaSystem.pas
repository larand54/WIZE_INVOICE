...
type
 TAmbiguityEvent = procedure(
  ...
  TdmsSystem = class(TDataModule)
    ...
    sq_Get_NoOfDaysDiscount2: TADQuery;
    sq_Get_NoOfDaysDiscount2NoOfDaysDiscount2: TIntegerField;
    sp_Vis_Upd_ProdCodeInfo: TADStoredProc;
    ...
    sp_MovePkgToInvFromLoad: TADStoredProc;
    cds_pkgLogShiftNo: TIntegerField;
    sp_Kontraktsnr: TADStoredProc;
    sp_GetOrderData: TADStoredProc;
  ...
  public
    ...
    procedure Generate_Vis_Upd_ProdCodeInfo(const InternalInvoiceNo, StatCodeIncl : Integer) ;
    ...
    function  GetLogonParams(var HostName, Database, UserName, Password, CRpath : String;var intsec : integer) : Boolean ;
    ...
    function  LoadGridLayout_Special(const UserID : Integer;const Form, ViewName : String;AGridView: TcxGridTableView) : Boolean ;
    procedure StoreGridLayout(const UserID : Integer;const ViewName : String;AGridView: TcxGridTableView) ;
    procedure StoreGridLayout_Special(const UserID : Integer;const Form, ViewName : String;AGridView: TcxGridTableView) ;
...
function TdmsSystem.GetLogonParams(var HostName, Database, UserName, Password, CRpath : String;var intsec : integer) : Boolean ;
Begin
 sq_dbProps.Open ;
...
procedure TdmsSystem.StoreGridLayout_Special(const UserID : Integer;const Form, ViewName : String;AGridView: TcxGridTableView) ;
var
  Stream: TMemoryStream;
begin
 With dmsSystem do
...
function TdmsSystem.LoadGridLayout_Special(const UserID : Integer;const Form, ViewName : String;AGridView: TcxGridTableView) : Boolean ;
var
  Stream: TMemoryStream;
begin
 Result:= False ;
...
begin
 Try
  ...
  qryExec.SQL.Add('AND LSP.LoadNo not in (Select inl.LoadNo FROM dbo.Invoiced_Load inl') ;
  qryExec.SQL.Add('Inner Join dbo.InvoiceNo_VTA invno on invno.InternalInvoiceNo = inl.InternalInvoiceNo') ;
  qryExec.SQL.Add('Inner Join dbo.InvoiceHeader ih on ih.InternalInvoiceNo = inl.InternalInvoiceNo') ;
  qryExec.SQL.Add('WHERE inl.LoadNo = LSP.LoadNo') ;
...
Begin
 sq_Get_NoOfDaysDiscount2.ParamByName('PAYMENTTERMSNO').AsInteger :=  PaymentTermsNo ;
...
procedure TdmsSystem.Generate_Vis_Upd_ProdCodeInfo(const InternalInvoiceNo, StatCodeIncl : Integer) ;
Begin
 Try
  sp_Vis_Upd_ProdCodeInfo.ParamByName('@InternalInvoiceNo').AsInteger  := InternalInvoiceNo ;
  sp_Vis_Upd_ProdCodeInfo.ParamByName('@StatCodeIncl').AsInteger       := StatCodeIncl ;
